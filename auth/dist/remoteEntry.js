...
(() => {
  ...
  var e,
    ...
    d = {
      8678: (e, r, t) => {
        var a = {
            "./AuthApp": () =>
              Promise.all([t.e(858), t.e(388), t.e(271), t.e(795)]).then(
                () => () => t(6795)
              ),
          },
          n = (e, r) => (
  ...
  function c(e) {
    ...
    var t = (h[e] = { exports: {} });
    return d[e](t, t.exports, c), t.exports;
  }
  (c.m = d),
    (c.c = h),
    (c.n = (e) => {
    ...
    (c.u = (e) =>
      ...
      "." +
      {
        250: "34d99d725f72205e76ae",
        271: "5b059775124cce3c521a",
        294: "dfb8e8199923b69cd5cd",
        388: "403c85c23ecad44988a1",
        795: "fc85cdbb1ec8f38b7a08",
        858: "8df7dedd3d75e92237f7",
        935: "4151bd505d4f85eec272",
      }[e] +
      ".js"),
    (c.g = (function () {
        ...
        if ((n || (n = r[t] = {}), !(a.indexOf(n) >= 0))) {
          ...
          var o = c.S[t],
            ...
            u = (e, r, t, a) => {
              var n = (o[e] = o[e] || {}),
                u = n[r];
              (!u || (!u.loaded && (!a != !u.eager ? a : i > u.from))) &&
          ...
          return (
            "default" === t &&
              (u("react-dom", "17.0.2", () =>
                Promise.all([c.e(935), c.e(271)]).then(() => () => c(3935))
              ),
              u("react-router-dom", "5.3.4", () =>
                Promise.all([c.e(250), c.e(858), c.e(271)]).then(
                  () => () => c(250)
                )
              ),
              u("react", "17.0.2", () => c.e(294).then(() => () => c(9976)))),
    ...
    (n = (e, r) => {
      ...
      for (i = 1; i < e.length; i++) {
        var p = e[i];
        h.push(1 == p ? c() | c() : 2 == p ? c() & c() : p ? n(p, r) : !c());
      }
      return !!c();
    }),
    (o = (e, r, t) => {
    ...
    (u = ((e) =>
      function (r, t, a, n) {
        var o = c.I(r);
        return o && o.then
          ? o.then(e.bind(e, r, c.S[r], t, a, n))
          : e(0, c.S[r], t, a, n);
      })((e, r, t, a, n) => {
      var u = r && c.o(r, t) && o(r, t, a);
      return u ? i(u) : n();
    })),
    (l = {}),
    (f = {
    ...
    (s = { 271: [7271], 795: [334, 7650] }),
    (c.f.consumes = (e, r) => {
      c.o(s, e) &&
        s[e].forEach((e) => {
          if (c.o(l, e)) return r.push(l[e]);
          var t = (r) => {
              (l[e] = 0),
                (c.m[e] = (t) => {
          ...
          try {
            var n = f[e]();
            n.then ? r.push((l[e] = n.then(t).catch(a))) : t(n);
          } catch (e) {
            a(e);
          }
        });
    ...
    (() => {
      ...
      var r = (r, t) => {
          ...
          for (r && r(t); l < o.length; l++)
            (n = o[l]), c.o(e, n) && e[n] && e[n][0](), (e[n] = 0);
        },
        t = (self.webpackChunkauth = self.webpackChunkauth || []);
